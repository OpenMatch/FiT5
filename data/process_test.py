...
trec='/dataset/msmarco/passage/test_rank.tsv'
queries_path='/dataset/msmarco/passage/docleaderboard-queries.tsv'
...
rank = 0
with open('/dataset/msmarco/passage/test_cocondenser_mine_global.json', 'w') as outfile:
    total_len = 0
...
with open('/dataset/msmarco/passage/test_cocondenser_mine_global.trec', 'w') as w:
    with open('/dataset/msmarco/passage/test_cocondenser_mine_global.json', 'r') as r:
